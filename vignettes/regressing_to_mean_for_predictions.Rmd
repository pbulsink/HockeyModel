...
vignette: >
  %\VignetteIndexEntry{Regression to Mean}
...
The above are all of the teams in the nhl in the last 5 years. If each of them play eachother now, we have lambda and mu ranging from `r min(lambdas)` to `r max(lambdas)`, with a mean of `r mean(lambdas)`. 
