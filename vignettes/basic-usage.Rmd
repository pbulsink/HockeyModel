...
simulatePlayoffs(summary_results = readRDS(url("https://github.com/pbulsink/HockeyModel/raw/refs/heads/master/data/summary_results_testing.rda", "rb")))
```
```{r playoff_solver, echo=FALSE}
po <- simulatePlayoffs(summary_results = HockeyModel::summary_results_testing, nsims = 10, cores = 1)
