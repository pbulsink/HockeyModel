...
predictions<-loopless_sim(nsims = 1e4, schedule = schedule, rho=rho, m=m)
...
new_predict<-loopless_sim(nsims = 1e4, schedule = newschedule, scores = newscores, rho=rho, m=m)
```
...
predict_home_ot<-loopless_sim(nsims = 1e4, schedule = newschedule, scores = home_ot_score, rho=rho, m=m)
predict_home_so<-loopless_sim(nsims = 1e4, schedule = newschedule, scores = home_so_score, rho=rho, m=m)
predict_away_win<-loopless_sim(nsims = 1e4, schedule = newschedule, scores = away_win_score, rho=rho, m=m)
predict_away_ot<-loopless_sim(nsims = 1e4, schedule = newschedule, scores = away_ot_score, rho=rho, m=m)
predict_away_so<-loopless_sim(nsims = 1e4, schedule = newschedule, scores = away_so_score, rho=rho, m=m)
