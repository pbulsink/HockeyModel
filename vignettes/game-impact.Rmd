...
predictions<-remainderSeasonDC(nsims = 2e3, schedule = schedule, rho=rho, m=m, regress = TRUE)
...
new_predict<-remainderSeasonDC(nsims = 2e3, schedule = newschedule, scores = newscores, rho=rho, m=m, regress = TRUE)
```
...
predict_home_ot<-remainderSeasonDC(nsims = 2e3, schedule = newschedule, scores = home_ot_score, rho=rho, m=m, regress = TRUE)
predict_home_so<-remainderSeasonDC(nsims = 2e3, schedule = newschedule, scores = home_so_score, rho=rho, m=m, regress = TRUE)
predict_away_win<-remainderSeasonDC(nsims = 2e3, schedule = newschedule, scores = away_win_score, rho=rho, m=m, regress = TRUE)
predict_away_ot<-remainderSeasonDC(nsims = 2e3, schedule = newschedule, scores = away_ot_score, rho=rho, m=m, regress = TRUE)
predict_away_so<-remainderSeasonDC(nsims = 2e3, schedule = newschedule, scores = away_so_score, rho=rho, m=m, regress = TRUE)
...
With nsims set to `2e3`, these can be vary noisy odds. Sometimes even San Jose's odds can go up when Arizona wins.  For better simulations, try `1e4` or `1e5` to smooth out the simulation repeatability and lock in a value. 
