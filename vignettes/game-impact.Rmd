...
predict_home_ot<-remainderSeasonDC(schedule = newschedule, scores = home_ot_score, rho=rho, m=m, regress = TRUE)
predict_home_so<-remainderSeasonDC(schedule = newschedule, scores = home_so_score, rho=rho, m=m, regress = TRUE)
predict_away_win<-remainderSeasonDC(schedule = newschedule, scores = away_win_score, rho=rho, m=m, regress = TRUE)
predict_away_ot<-remainderSeasonDC(schedule = newschedule, scores = away_ot_score, rho=rho, m=m, regress = TRUE)
predict_away_so<-remainderSeasonDC(schedule = newschedule, scores = away_so_score, rho=rho, m=m, regress = TRUE)
