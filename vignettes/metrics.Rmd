...
bt.16p<-remainderSeasonBT(scores = NULL, schedule = sc17, odds = TRUE, fittedBT = btfitted)
bt.16<-simulateSeasonParallel(odds_table = bt.16p, nsims = n, scores = NULL, schedule = sc17, cores = 10)$summary_results

btgdfitted <- readRDS("../data-raw/metricBTGDFitted.RDS")
btgd.16p<-remainderSeasonBT(scores = NULL, schedule = sc17, odds = TRUE, fittedBT = btgdfitted)
btgd.16<-simulateSeasonParallel(odds_table = btgd.16p, nsims = n, scores = NULL, schedule = sc17, cores = 10)$summary_results
...
results = data.frame('model' = c('elo', 'dc','dc5','dc1','bt', 'btgd', 'ml'), 
