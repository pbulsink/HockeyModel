...
n <- 1000 # number of season simulations to get odds.
cores <- 6 # number of cores to use in simulations
...
gameLogLoss = list('elo.15' = MLmetrics::LogLoss(y_pred = elo.15p$HomeWin+elo.15p$Draw*elo.15p$HomeWin, y_true = results16$Result),
                   'elo.16' = MLmetrics::LogLoss(y_pred = elo.16p$HomeWin+elo.16p$Draw*elo.16p$HomeWin, y_true = results17$Result),
                   'dc10.15' = MLmetrics::LogLoss(y_pred = dc10.15p$HomeWin+dc10.15p$Draw*dc10.15p$HomeWin, y_true = results16$Result),
                   'dc10.16' = MLmetrics::LogLoss(y_pred = dc10.16p$HomeWin+dc10.16p$Draw*dc10.16p$HomeWin, y_true = results17$Result),
                   'dc5.15' = MLmetrics::LogLoss(y_pred = dc5.15p$HomeWin+dc5.15p$Draw*dc5.15p$HomeWin, y_true = results16$Result),
                   'dc5.16' = MLmetrics::LogLoss(y_pred = dc5.16p$HomeWin+dc5.16p$Draw*dc5.16p$HomeWin, y_true = results17$Result),
                   'dc1.15' = MLmetrics::LogLoss(y_pred = dc1.15p$HomeWin+dc1.15p$Draw*dc1.15p$HomeWin, y_true = results16$Result),
                   'dc1.16' = MLmetrics::LogLoss(y_pred = dc1.16p$HomeWin+dc1.16p$Draw*dc1.16p$HomeWin, y_true = results17$Result)
                   )
...
playoffLogLoss = list('elo.15' = MLmetrics::LogLoss(y_pred = elo.15$Playoffs, y_true = stats16$Playoffs),
                      'elo.16' = MLmetrics::LogLoss(y_pred = elo.16$Playoffs, y_true = stats17$Playoffs),
                      'dc10.15' = MLmetrics::LogLoss(y_pred = dc10.15$Playoffs, y_true = stats16$Playoffs),
                      'dc10.16' = MLmetrics::LogLoss(y_pred = dc10.16$Playoffs, y_true = stats17$Playoffs),
                      'dc5.15' = MLmetrics::LogLoss(y_pred = dc5.15$Playoffs, y_true = stats16$Playoffs),
                      'dc5.16' = MLmetrics::LogLoss(y_pred = dc5.16$Playoffs, y_true = stats17$Playoffs),
                      'dc1.15' = MLmetrics::LogLoss(y_pred = dc1.15$Playoffs, y_true = stats16$Playoffs),
                      'dc1.16' = MLmetrics::LogLoss(y_pred = dc1.16$Playoffs, y_true = stats17$Playoffs)
                      )
...
results = tibble::tibble('model' = c('elo.15', 'elo.16', 'dc.15', 'dc.16', 'dc5.15', 'dc5.16', 'dc1.15', 'dc1.16'), 
