...
prepareDataForBT2 <- function() {
  advanced_scores$Season <- as.factor(HockeyModel:::vGetSeason(advanced_scores$Date))
  ...
  as3 <- data_frame(Date = c(as2$Date, as2$Date),
    ...
    dplyr::mutate(last.game = dplyr::lag(Pts, 1, default = 0),
           CEF.20 = zoo::rollapplyr(EvenCF, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CEA.20 = zoo::rollapplyr(EvenCA, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CEp.20 = zoo::rollapplyr(EvenCFp, 20, mean, patial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CCF.20 = zoo::rollapplyr(CloseCF, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CCA.20 = zoo::rollapplyr(CloseCA, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CCp.20 = zoo::rollapplyr(CloseCFp, 20, mean, patial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CAF.20 = zoo::rollapplyr(AllCF, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CAA.20 = zoo::rollapplyr(AllCA, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           CAp.20 = zoo::rollapplyr(AllCFp, 20, mean, patial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           hits.20 = zoo::rollapplyr(Hits, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           shotF.20 = zoo::rollapplyr(ShotsF, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           shotA.20 = zoo::rollapplyr(ShotsA, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           blocks.20 = zoo::rollapplyr(Blocks, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           shp.20 = zoo::rollapplyr(SHp, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           sv.20 = zoo::rollapplyr(Saves, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           svp.20 = zoo::rollapplyr(SVp, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           PDO.20 = zoo::rollapplyr(PDO, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
           ShftLngth.20 = zoo::rollapplyr(Hits, 20, mean, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA)),
    ...
    dplyr::mutate(last.20 = zoo::rollapplyr(ShftLngth, 20, sum, partial = TRUE, na.rm = TRUE, fill = c(NA, 'extend', NA))) %>%
    dplyr::ungroup() %>%
