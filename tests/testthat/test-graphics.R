...
test_that("Playoff Table is ok", {
  po<-structure(list(Team = c("Tampa Bay Lightning", "Colorado Avalanche", "Carolina Hurricanes", "Vegas Golden Knights", "Pittsburgh Penguins", "Dallas Stars", "Florida Panthers", "Toronto Maple Leafs", "New York Islanders", "Edmonton Oilers", "Boston Bruins", "Winnipeg Jets", "Washington Capitals", "New York Rangers", "Calgary Flames", "Minnesota Wild", "Nashville Predators", "St. Louis Blues", "Columbus Blue Jackets", "Chicago Blackhawks", "Montreal Canadiens", "Vancouver Canucks", "Los Angeles Kings", "Philadelphia Flyers", "San Jose Sharks", "Anaheim Ducks", "Arizona Coyotes", "Ottawa Senators", "Detroit Red Wings", "New Jersey Devils", "Buffalo Sabres", "Seattle Kraken"),
